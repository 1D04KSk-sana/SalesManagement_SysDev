...
namespace SalesManagement_SysDev
{
    internal class SyukkoDataAccess
    {
        ...
        public List<T_Syukko> GetOrSyukkoData(T_Syukko selectSyukko)
        {
            ...
            {
                var context = new SalesManagement_DevContext();
                listProdact = context.T_Syukkos.Where(x => x.SyID == selectSyukko.SyID || x.SoID == selectSyukko.SoID || x.OrID == selectSyukko.OrID || x.ClID == selectSyukko.ClID || x.EmID == selectSyukko.EmID || x.SyDate.Value == selectSyukko.SyDate).ToList();
