...
namespace SalesManagement_SysDev
{
    internal class ChumonDataAccess
    {
        ...
        public List<T_Chumon> GetOrChumonData(T_Chumon selectChumon)
        {
            ...
            {
                var context = new SalesManagement_DevContext();
                listChumon = context.T_Chumons.Where(x => x.OrID == selectChumon.OrID || x.SoID == selectChumon.SoID || x.ChID == selectChumon.ChID || x.ClID == selectChumon.ClID|| x.ChDate.Value == selectChumon.ChDate.Value).ToList();
